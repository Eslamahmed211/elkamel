...
@section('body')
    ...
    <div class="relative my-10">
        ...
        <div class="">
            ...
            @foreach (App\Models\service::get() as $service)
                @if ($loop->index % 2 == 0)
                    <div
                        ...
                        <img src="{{ path($service->img) }}" alt="img" class="shadow-lg" />
                        <div>
            ...
            {{-- <div
                class="relative p-5 container flex flex-col lg:flex-row justify-center items-center gap-[15%] gap-y-10 my-20">
                <img src="../images/silverCircle.svg" alt="image" class="absolute -top-[10rem] right-5" />
                <img src="../images/services3.png" alt="img" class="max-w-[50%]" />
                <div>
                    <div class="flex flex-col justify-center gap-2 mb-3">
                        <p class="text-[32px] md:text-[48px] text-[#000] font-[700]">
                            لوريم ايبسوم دولار
                    ...
                    <p class="text-[16px] text-[#000] font-[500] max-w-[540px]">
                        ...
                        يوت انيم أدلوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج
                        أليايت,سيت دو أيوسمود تيمبور أنكايديديونتيوت لابوري ات دولار ماجنا
                        أليكيوا . يوت انيم أدلوريم ايبسوم دولار سيت أميت ,كونسيكتيتور
                        أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور أنكايديديونتيوت لابوري
                        ات دولار ماجنا أليكيوا . يوت انيم أدلوريم ايبسوم دولار سيت أميت
                        ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبور
                        أنكايديديونتيوت لابوري ات دولار ماجنا أليكيوا . يوت انيم أدلوريم
                        ...
                        انيم أدلوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج
                        أليايت,سيت دو أيوسمود تيمبور أنكايديديونتيوت لابوري ات دولار ماجنا
                        أليكيوا . يوت انيم أد
                    </p>
