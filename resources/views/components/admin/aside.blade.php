<aside id="aside">
    <ul id="links">
        ...
        <a href="/home" class="p-0"> <img src="{{ get_logo() }}" alt="logo" class="logo d-lg-none"></a>
        ...
        @can('has', 'projects')
            <li class="projects">
                <a href="/admin/projects"> <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @can('has', 'courses')
        <li class="courses">
            <a href="/admin/courses"> <svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
                </svg>
    ...
    @endcan
        ...
        @can('has', 'emails')
            <li class="emails">
                <a href="/admin/emails"><svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @can('has', 'messages')
            <li class="messages">
                <a href="/admin/messages"><svg width="20" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
