...
@section('path')
    <ul class="paths">
        <li> <a href="{{ url('admin/about?tab=nav-mission') }}"> مهمتنا واهدافنا / </a> </li>
        <li class="active"> {{ $mission->title }} / </li>
...
@section('content')
    <div class=" mt-lg-4 mx-3  ">
        ...
        <form class="row bg-white  py-4 px-2 rounded" action="/admin/missions/{{ $mission->id }}" method="post"
            ...
            <div class="col-lg-6 col-12" title="العنوان">
                <x-admin.forms.input for="title" value="{{ $mission->title }}" lable_title="العنوان" name="title"
                    placeholder="العنوان">
                </x-admin.forms.input>
            </div>
