...
@section('content')
    <div class=" mt-lg-4 mx-3  ">
        <form action="/admin/projects/{{ $project->id }}/storeImgs" method="post" enctype="multipart/form-data">
        ...
        <x-admin.forms.deleteModel withoutTitle model="projects/project_images" id="img_id"></x-admin.forms.deleteModel>
...
@section('js')
    <script>
        ...
        $('#ssi-uploader').ssi_uploader({
            ...
            <x-admin.extra.move model="projects/product_images"></x-admin.extra.move>
